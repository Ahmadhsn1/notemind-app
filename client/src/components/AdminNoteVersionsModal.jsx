...
function AdminNoteVersionsModal({noteId, noteTitle, onClose}) {
	...
	return (
		...
		>
			<div className="w-full max-w-[520px] max-h-[80vh] bg-[linear-gradient(160deg,var(--color-panel-a),var(--color-panel-b))] border border-accent/35 rounded-[20px] p-4 min-[381px]:p-6 shadow-[0_24px_60px_rgba(0,0,0,0.45)] flex flex-col gap-3.5">
